package com.learnandpost.image.uploader.portlet;
...
import com.learnandpost.image.uploader.util.UploadImageUtil;
...
@Component(
	immediate = true,
	property = {		
		"javax.portlet.name=com_liferay_image_uploader_web_portlet_ImageUploaderPortlet",
		"mvc.command.name=/image_uploader/view",
        "service.ranking:Integer=100"
	},
	service = MVCActionCommand.class
)
public class ExtUploadImageMVCActionCommandPortlet extends BaseMVCActionCommand {
	...
	protected FileEntry addTempImageFileEntry(PortletRequest portletRequest)
			...
			fileName = uploadPortletRequest.getFileName(fileNameStr);
			
			if(fileName==null || fileName.isEmpty()){
				fileNameStr = "captureme";
				fileName = uploadPortletRequest.getFileName(fileNameStr);
			}
			
			String contentType = uploadPortletRequest.getContentType(fileNameStr);
			
			File file = uploadPortletRequest.getFile(fileNameStr);
		...
		private static final Log _log = LogFactoryUtil.getLog(
				ExtUploadImageMVCActionCommandPortlet.class);
