					...
					<aui:fieldset-group markupView="lexicon">
						<aui:fieldset cssClass="lfr-portrait-editor">
							...
							<% if(BrowserSnifferUtil.isMobile(request)){ %>
								<div class="button-holder">
									<label class="btn btn-default" for="<portlet:namespace />captureme"><liferay-ui:message key="Capture" /></label>
									<input type="file" capture="camera" class="hide" accept="image/*" id="<portlet:namespace />captureme" name="<portlet:namespace />captureme">
								</div>				
							<% } %>
						</aui:fieldset>
					</aui:fieldset-group>
